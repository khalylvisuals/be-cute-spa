  ...
  return (
    <section id="packages" className="section-padding bg-cream-100">
      <div className="mx-auto max-w-7xl px-5 sm:px-6 lg:px-8">
        <SectionHeader 
          kicker="Nos packs"
          title="Packages bien-être"
          subtitle="Combinez hammam et massage pour une expérience complète, pensée pour détendre le corps et apaiser l’esprit."
        />
              ...
              <div className="relative z-10 flex flex-col flex-grow">
                ...
                <div className="mt-auto">
                  <div className="mb-7 space-y-3 border-y border-sand-300/15 py-5">
                    ...
                    <div className="flex items-center justify-between gap-5">
                      <span className="text-xs font-medium uppercase tracking-wide-plus text-ink/75">Prix</span>
                  ...
                  <a
                    href={getWhatsAppLink(pkg.title, false)}
                    target="_blank"
