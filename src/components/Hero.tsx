        ...
        <div className="text-center">
          <h1 className="mb-6 flex flex-col items-center gap-2">
            ...
            <span className="luxury-heading text-lg sm:text-xl font-light uppercase tracking-[0.2em] text-gold-500 mt-4">
              Spa, Hammam & Massage à Rabat Agdal
            </span>
          </h1>

          <p className="mx-auto mb-9 max-w-3xl text-base font-light leading-relaxed text-ivory-50/90 sm:text-lg">
            Découvrez BE CUTE SPA à Rabat Agdal, un espace dédié au bien-être avec hammam marocain traditionnel, massages relaxants et formules bien-être. Profitez d'un moment de détente dans un cadre élégant et apaisant, avec une réservation simple par téléphone ou WhatsApp.
          </p>
