      ...
      <div className="max-w-7xl mx-auto px-5 sm:px-6 lg:px-8">
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-lg text-ink/75 font-light leading-relaxed">
            See the current rating and reviews directly on our Google listing.
          </p>
        </div>
        ...
        <div className="flex flex-col md:flex-row items-center justify-between bg-white border border-sand-300/20 p-8 mb-12 gap-8 shadow-sm">
          <div className="flex items-center gap-6">
            <span className="text-5xl font-display text-ink">{SITE.ratingValue}</span>
            <div className="flex flex-col gap-1">
              ...
              <span className="text-sm font-medium uppercase tracking-widest text-ink/70">/ 5 — {SITE.reviewCount} Google reviews</span>
            </div>
          </div>
          ...
          <div className="hidden md:flex items-center gap-8 border-l border-sand-300/30 pl-8">
            ...
            <div className="flex items-center gap-3 text-ink/80">
              ...
              <span className="text-sm font-medium">{SITE.openingHours.en.replace('Every day ', '')}</span>
            </div>
          </div>
